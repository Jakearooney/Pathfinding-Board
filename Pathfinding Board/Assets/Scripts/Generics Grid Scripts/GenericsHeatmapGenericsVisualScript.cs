...
public class GenericsHeatmapGenericsVisualScript : MonoBehaviour
{
    ...
    public void SetGrid(GenericsGridScript<HeatMapGridObject> grid)
    {
        this.grid = grid;
        UpdateHeatMapVisual();
    ...
    private void GenericsGridScript_OnGridObjectChanged(object sender, GenericsGridScript<HeatMapGridObject>.OnGridObjectChangedEventArgs e)
    {
        //UpdateHeatMapVisual();
        updateMesh = true;
    }
